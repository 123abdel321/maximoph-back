        ...
        if(typeERP !=3 ) { //SINCRONIZAR CECOS, CUENTAS, COMRPOBANTES
            ...
            dataFromERP.forEach(async (nitERP) => {
                ...
                if (id_nit) { //ACTUALIZAR SI EXITE NIT 
                    ...
                    await pool.query(`INSERT INTO personas (id_tercero_erp, tipo_documento, numero_documento, primer_nombre, segundo_nombre, primer_apellido, segundo_apellido, telefono, celular, email, direccion, fecha_nacimiento, sexo, avatar, importado) VALUES (${nitERP.id},${nitERP.id_tipo_documento && nitERP.id_tipo_documento != null ? nitERP.id_tipo_documento : '""'},${nitERP.numero_documento && nitERP.numero_documento != null ? nitERP.numero_documento : '""'},${nitERP.primer_nombre && nitERP.primer_nombre != null ? "'"+nitERP.primer_nombre+"'" : '""'},${nitERP.otros_nombres && nitERP.otros_nombres != null ? "'"+nitERP.otros_nombres+"'" : '""'},${nitERP.primer_apellido && nitERP.primer_apellido != null ? "'"+nitERP.primer_apellido+"'" : '""'},${nitERP.segundo_apellido && nitERP.segundo_apellido != null ? "'"+nitERP.segundo_apellido+"'" : '""'},${nitERP.telefono_1 && nitERP.telefono_1 != null ? nitERP.telefono_1 : '""'},${nitERP.telefono_2 && nitERP.telefono_2 != null ? nitERP.telefono_2 : '""'},${nitERP.email && nitERP.email != null ? "'"+nitERP.email+"'" : '""'},${nitERP.direccion && nitERP.direccion != null ? "'"+nitERP.direccion+"'" : '""'},'','','','')`);
                }
            });
        }
